...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* ═══ TENTANG KAMI ═══ */}
      <section className="px-6 py-28 bg-primary-foreground">
      ...
      {/* ═══ LAYANAN ═══ */}
      <section className="px-6 py-28 bg-gradient-to-b from-primary-foreground to-orange-50">
        <div className="mx-auto max-w-6xl">
      ...
      <section className="px-6 py-28 bg-orange-50">
        <div className="mx-auto max-w-6xl">
          <FadeIn className="text-center">
