...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className={`mt-4 flex h-16 items-center justify-between rounded-2xl border border-border/50 px-8 shadow-lg shadow-black/5 backdrop-blur-xl transition-all duration-300 ${scrolled ? "bg-background/90" : "bg-background/70"}`}>
            ...
            <div className="hidden md:flex items-center ml-auto">
              <ul className="flex items-center gap-2 text-right">
                <li>
                  <a href="#beranda" className="px-4 py-2 text-[13px] font-medium text-muted-foreground hover:text-primary transition-colors rounded-xl">Beranda</a>
                </li>
                <li>
                  <a href="#tentang" className="px-4 py-2 text-[13px] font-medium text-muted-foreground hover:text-primary transition-colors rounded-xl">Tentang</a>
                </li>
                <li>
                  <a href="#kemitraan" className="px-4 py-2 text-[13px] font-medium text-muted-foreground hover:text-primary transition-colors rounded-xl">Kemitraan</a>
                </li>
                <li>
      ...
      <section ref={heroRef} id="home" className="relative overflow-hidden px-4 pt-24 pb-16 sm:px-6 lg:flex lg:min-h-[100dvh] lg:items-center lg:pt-0 lg:pb-0">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -left-2 top-28 rounded-2xl border border-border/50 bg-card/80 p-4 shadow-xl backdrop-blur-md will-change-transform"
              >
                <div className="flex items-center gap-3">
              ...
              <motion.div
                ...
                className="absolute bottom-28 right-4 rounded-2xl border border-border/50 bg-card/80 p-5 shadow-xl backdrop-blur-md will-change-transform"
              >
      ...
      <section id="about" className="relative overflow-hidden bg-accent px-6 py-28 text-accent-foreground">
      ...
      <section id="transition" className="flex justify-between">
        {/* Transition Divider Cards - seamless top blend with layanan, top blue, bottom white with dots */}
        <div className="relative w-full flex justify-center items-center z-30 pb-24 sm:pb-32">
          {/* Top blue background with soft white fade for seamless layanan transition */}
          <div className="absolute left-0 right-0 top-0 h-1/2 z-0" style={{
            background: "linear-gradient(to bottom, #183A6D 0%, rgba(255,255,255,0.7) 100%)"
          }} />
          {/* Bottom white background with dots */}
          <div className="absolute left-0 right-0 bottom-0 h-1/2 z-0">
            <BackgroundDots mouseX={mouseX} mouseY={mouseY} />
          </div>
          <div id="section-stats" className="relative z-20 w-full max-w-6xl flex justify-between items-end">
            <motion.div
            ...
            >
              {/* Left card - p-bottom, overlaps up */}
              <div
                className="group rounded-3xl border border-border/50 bg-white h-[300px] w-[90vw] max-w-[220px] mx-auto flex flex-col justify-center items-center shadow-2xl backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:shadow-2xl sm:-translate-y-6 z-30"
              >
                <p className="text-3xl font-bold tabular-nums sm:text-5xl text-primary">
                  <AnimatedNumber value={15} suffix={"+"} />
                </p>
                <p className="mt-4 text-[14px] uppercase tracking-wide text-muted-foreground sm:text-[16px]">Outlet Aktif</p>
              </div>
              {/* Center card - p-top, overlaps down */}
              <div
                className="group rounded-3xl border border-border/50 bg-white h-[280px] w-[95vw] max-w-[260px] mx-auto flex flex-col justify-center items-center shadow-2xl backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:shadow-2xl sm:translate-y-24 z-40"
              >
                <p className="text-4xl font-bold tabular-nums sm:text-6xl text-primary">
                  <AnimatedNumber value={65} suffix={"%"} />
                </p>
                <p className="mt-4 text-[16px] uppercase tracking-wide text-muted-foreground sm:text-[18px]">ROI Tahunan</p>
              </div>
              {/* Right card - p-bottom, overlaps up, responsive */}
              <div
                className="group rounded-3xl border border-border/50 bg-white h-[300px] w-[90vw] max-w-[220px] mx-auto flex flex-col justify-center items-center shadow-2xl backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:shadow-2xl sm:-translate-y-6 z-30"
              >
                <p className="text-3xl font-bold tabular-nums sm:text-5xl text-primary">
                  <AnimatedNumber value={19} suffix={" Bln"} />
                </p>
                <p className="mt-4 text-[14px] uppercase tracking-wide text-muted-foreground sm:text-[16px]">Payback Period</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="service" className="relative px-6 py-28 overflow-hidden">
        <BackgroundDots mouseX={mouseX} mouseY={mouseY} />
      ...
      <section id="process" className="relative bg-accent px-6 py-28 text-accent-foreground overflow-hidden">
      ...
      <section
        id="roi"
        className="px-6 py-28 relative overflow-hidden bg-[#E6E6FA]/30"
      >
      ...
      <section
        id="faq"
        className="relative px-6 py-28 overflow-hidden text-black bg-blue-50/50"
      >
