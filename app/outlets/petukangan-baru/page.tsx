...
export default function PetukanganBaruOutlet() {
  ...
  const position: [number, number] = [-6.2288242693238995, 106.74686754991355];
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/mesin/mesin_ptkbaru2.jpg')",
