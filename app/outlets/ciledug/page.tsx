...
export default function CiledugOutlet() {
  ...
  const position: [number, number] = [-6.2145506181164745, 106.71019678529633];
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/mesin/mesin_ciledug2.jpg')",
