...
export default function CipeteUtaraOutlet() {
  ...
  const position: [number, number] = [-6.259982940300875, 106.8010249793894];
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/outlets/cipete2.jpg')",
